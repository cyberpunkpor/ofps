...
missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
	...
	["WMD Unlock", "<t>Unlock the Nuke Truck in the Light Factory and Rocket Artillery in the Light-Heavy Factories.<br /><t color='#ffff00'>Unlocks Light 5!</t></t>"], //--- Nuke and Arty
