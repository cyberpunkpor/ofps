...
missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
	...
	["WMD Unlock", "<t>Unlocks the Nuke Truck in the Light factory and Rocket Artillery in the Light and Heavy factories.<br /><t color='#ffff00'>Unlocks Light 5!</t></t>"], //--- Nuke and Arty
