...
missionNamespace setVariable [Format["CTI_%1_UPGRADES_LINKS", _side], [
	...
	[[CTI_UPGRADE_LIGHT,1],[CTI_UPGRADE_HEAVY,2],[CTI_UPGRADE_AIR_ROTARY,3],[CTI_UPGRADE_AIR_ROTARY,4],[CTI_UPGRADE_NUKE,1]], //--- Air Fixed
	[[],[],[],[]], //--- Air Ordinance 
	[[],[],[],[]], //--- Land Ordinance
...
missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
	...
	["CM", "<t>Enables countermeasures which decoy incoming guided missiles. Heavy Factory vehicles only; amount per vehicle determined by upgrade (level 1 vehicle = 1 max CM charge, regardless of CM upgrade level).<br />	
