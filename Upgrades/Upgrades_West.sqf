...
missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
	...
	["LVOSS System", "<t>Enables the Light Vehicle Obscuration Smoke System (LVOSS) with full 360 degree coverage.<br />
	...
	["ERA/APS System", "<t>Enables Explosive Reactive Armor (ERA), which absorb incoming light AT rockets. Later unlocks an Active Protection System (APS) which destroys incoming projectiles before impact. ERA and APS are for Heavy vehicles only.<br />
