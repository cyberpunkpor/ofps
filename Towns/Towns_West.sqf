...
if (CTI_VANILLA_ADDON > 0) then {
	...
	WEST_TOWN_M134_COMP = WEST_TOWN_MGLO_COMP; //fallback for vanilla
};
...
if (CTI_CUP_WEAPONS_ADDON > 0) then {
	...
	WEST_TOWN_D30 = "CUP_B_D30_AT_CDF";
...
if (CTI_OFPS_UNITS_ADDON > 0) then {
	...
	WEST_TOWN_MK29 = "OFPS_CENTURION_B_4KM";
...
if (CTI_OFPS_HAFM_ADDON > 0) then {
	...
	WEST_NAVAL_CAPITAL_ASSAULT_BOAT = "OFPS_GUNBOAT_B";
};
//--- Unsung
...
if (CTI_TOWNS_OCCUPATION_WEST isEqualTo 2) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		WEST_AIR_HELI1 = "CUP_B_AH6M_USA";
		WEST_AIR_HELI2 = "CUP_B_MH60L_DAP_4x_US";
		WEST_AIR_HELI_ATTACK = "CUP_B_AH64_DL_USA";
...
if (CTI_TOWNS_OCCUPATION_WEST isEqualTo 4) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		//WEST_SOLDIER_NAVAL_SQUADLEADER = "B_diver_TL_F";
		//--- Light Vehicles
		WEST_VEHICLE_LIGHT1 = "CUP_B_M1151_Deploy_WDL_USA";
...
if (CTI_TOWNS_OCCUPATION_WEST isEqualTo 8) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		WEST_AIR_HELI1 = "CUP_B_AH6M_USA";
		WEST_AIR_HELI2 = "CUP_B_MH60L_DAP_4x_US";
		WEST_AIR_HELI_ATTACK = "CUP_B_AH1Z_Dynamic_USMC";
		WEST_AIR_AA = "CUP_B_F35B_AA_USMC";
		WEST_AIR_CAS = "CUP_B_F35B_LGB_USMC";
		//--- Boats
		//WEST_NAVAL_ASSAULT_BOAT1 = "B_Boat_Armed_01_minigun_F";
...
inside init place | this setVariable ["cti_static_defense", ["TOWN_MG","TOWN_GL"]]; //to set radnom
...
//--- Statics Groups
WEST_TOWNS_STATICS_ALL = [WEST_TOWN_MG,WEST_TOWN_GL,WEST_TOWN_AT,WEST_TOWN_AA,WEST_TOWN_IGLA,WEST_TOWN_KORDLO,WEST_TOWN_M2LO,WEST_TOWN_MGLO,WEST_TOWN_ZSU,WEST_TOWN_D30,WEST_TOWN_SPG,WEST_TOWN_DSHKM,WEST_TOWN_KORD,WEST_TOWN_MG50,WEST_TOWN_AGS,WEST_TOWN_COAST,WEST_TOWN_M134];
WEST_TOWNS_STATICS_CORE = [WEST_TOWN_MG,WEST_TOWN_GL,WEST_TOWN_AT];
WEST_TOWNS_STATICS_COMPS = [WEST_TOWN_MG_COMP + WEST_TOWN_GL_COMP + WEST_TOWN_AT_COMP + WEST_TOWN_SPG_COMP + WEST_TOWN_DSHKM_COMP + WEST_TOWN_MG50_COMP + WEST_TOWN_MGLO_COMP + WEST_TOWN_M2LO_COMP + WEST_TOWN_AGS_COMP + WEST_TOWN_KORDLO_COMP + WEST_TOWN_M134_COMP];
WEST_TOWNS_STATICS_INFANTRY = [WEST_TOWN_MG,WEST_TOWN_GL,WEST_TOWN_DSHKM,WEST_TOWN_KORD,WEST_TOWN_MG50,WEST_TOWN_AGS,WEST_TOWN_M134];
...
WEST_TOWNS_STATICS_ICOMPS = WEST_TOWN_MG_COMP + WEST_TOWN_GL_COMP + WEST_TOWN_DSHKM_COMP + WEST_TOWN_MG50_COMP + WEST_TOWN_MGLO_COMP + WEST_TOWN_M2LO_COMP + WEST_TOWN_KORDLO_COMP + WEST_TOWN_AGS_COMP + WEST_TOWN_M134_COMP;
WEST_TOWNS_STATICS_VCOMPS = WEST_TOWN_AT_COMP + WEST_TOWN_SPG_COMP;
WEST_TOWNS_STATICS_IV = WEST_TOWNS_STATICS_INFANTRY + WEST_TOWNS_STATICS_VEHICLE;
...
WEST_TOWNS_SQUAD_SNIPER = [WEST_SOLDIER_TEAMLEADER, WEST_SOLDIER_SNIPER, WEST_SOLDIER_SNIPER, WEST_SOLDIER_SNIPER, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_AT1 = [WEST_SOLDIER_TEAMLEADER, WEST_SOLDIER_LAT, WEST_SOLDIER_LAT, WEST_SOLDIER_LAT, WEST_SOLDIER_MEDIC];
...
WEST_TOWNS_SQUAD_AT1_U = [WEST_SOLDIER_TEAMLEADER_U, WEST_SOLDIER_LAT_U, WEST_SOLDIER_LAT_U, WEST_SOLDIER_LAT_U, WEST_SOLDIER_MEDIC];
...
WEST_TOWNS_SQUAD_AIR1 = [WEST_AIR_HELI1];
WEST_TOWNS_SQUAD_AIR1_SQUAD2 = [WEST_AIR_HELI1, WEST_AIR_HELI1];
WEST_TOWNS_SQUAD_AIR1_SQUAD3 = [WEST_AIR_HELI1, WEST_AIR_HELI1, WEST_AIR_HELI1];
WEST_TOWNS_SQUAD_AIR2 = [WEST_AIR_HELI2];
WEST_TOWNS_SQUAD_AIR3 = [WEST_AIR_HELI_ATTACK];
WEST_TOWNS_SQUAD_AIR2_SQUAD2 = [WEST_AIR_HELI2, WEST_AIR_HELI2, WEST_AIR_HELI_ATTACK];
//--- Mixed Squads
