...
WEST_SOLDIER_SNIPER_U = "B_Soldier_M_F";
...
if (CTI_TOWNS_OCCUPATION_WEST isEqualTo 1) then { 
	...
	if (CTI_VANILLA_ADDON > 0) then {
		...
		//WEST_NAVAL_CAPITAL_ASSAULT_BOAT = "HAFM_PBoat";
...
//--- Statics Groups
WEST_TOWNS_STATICS_ALL = [WEST_TOWN_MG,WEST_TOWN_GL,WEST_TOWN_AT,WEST_TOWN_AA,WEST_TOWN_MORTAR,WEST_TOWN_ZSU,WEST_TOWN_D30,WEST_TOWN_SPG,WEST_TOWN_DSHKM,WEST_TOWN_MG50,WEST_TOWN_AGS,WEST_TOWN_COAST];
...
//Urban
WEST_TOWNS_SQUAD_RIFLEMEN1_U = [WEST_SOLDIER_SQUADLEADER_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_U, WEST_SOLDIER_U, WEST_SOLDIER_MEDIC_U];
