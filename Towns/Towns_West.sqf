...
if (CTI_CUP_WEAPONS_ADDON > 0) then {
	...
	WEST_TOWN_MG50 = "CUP_B_M2StaticMG_US";
	WEST_TOWN_M2LO = "CUP_B_M2StaticMG_MiniTripod_US";
...
//--- Infantry Squads
WEST_TOWNS_SQUAD_RIFLEMEN1 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AR, WEST_SOLDIER, WEST_SOLDIER_MARKSMAN, WEST_SOLDIER_MARKSMAN, WEST_SOLDIER, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_RIFLEMEN2 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AR, WEST_SOLDIER_AR, WEST_SOLDIER_MG, WEST_SOLDIER_EXP, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_RIFLEMEN3 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AR, WEST_SOLDIER_AR, WEST_SOLDIER_AR, WEST_SOLDIER_MG, WEST_SOLDIER_GL, WEST_SOLDIER_MEDIC];
...
//Urban
WEST_TOWNS_SQUAD_RIFLEMEN1_U = [WEST_SOLDIER_SQUADLEADER_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_U, WEST_SOLDIER_U, WEST_SOLDIER_MARKSMAN_U, WEST_SOLDIER_MARKSMAN_U, WEST_SOLDIER_U, WEST_SOLDIER_MEDIC_U];
WEST_TOWNS_SQUAD_RIFLEMEN2_U = [WEST_SOLDIER_SQUADLEADER_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_MG_U, WEST_SOLDIER_EXP_U, WEST_SOLDIER_MEDIC_U];
WEST_TOWNS_SQUAD_RIFLEMEN3_U = [WEST_SOLDIER_SQUADLEADER_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_AR_U, WEST_SOLDIER_MG_U, WEST_SOLDIER_GL_U, WEST_SOLDIER_MEDIC_U];
