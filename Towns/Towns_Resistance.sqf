...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 9) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		GUER_VEHICLE_AA3 = "CUP_I_ZSU23_AAF";
		//--- Air
		GUER_AIR_HELI1 = "CUP_I_Wildcat_Green_AAF";
		GUER_AIR_HELI2 = "CUP_I_Mi24_D_Dynamic_AAF";
		//GUER_AIR_AA = "";
		GUER_AIR_CAS = "CUP_O_Su25_Dyn_RU";
		//--- Boats
...
GUER_TOWNS_STATICS_ICOMPS = GUER_TOWN_MG_COMP + GUER_TOWN_GL_COMP + GUER_TOWN_DSHKM_COMP + GUER_TOWN_MG50_COMP + GUER_TOWN_MGLO_COMP + GUER_TOWN_M2LO_COMP + GUER_TOWN_KORDLO_COMP;
