...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 2) then { 
	...
	if (CTI_VANILLA_ADDON > 0) then {
		//-- Only add vanilla faction specific overrides as neeeded here
		//--- Infantry
		GUER_SOLDIER = "I_C_Soldier_Para_2_F";
		...
		GUER_SOLDIER_HAT = "I_Soldier_LAT_F";
		GUER_SOLDIER_ENGINEER = "I_G_engineer_F";
		GUER_SOLDIER_EXP = "I_Soldier_Para_8_F";
		GUER_SOLDIER_GL = "I_G_Soldier_GL_F";
		GUER_SOLDIER_MEDIC = "I_G_medic_F";
		GUER_SOLDIER_MG = "I_G_Soldier_AR_F";
		GUER_SOLDIER_PILOT = "I_G_officer_F";
		...
		GUER_VEHICLE_LIGHT4 = "I_C_Offroad_02_LMG_F";
		GUER_VEHICLE_LIGHT5 = "I_MRAP_03_hmg_F";
		GUER_VEHICLE_LIGHT6 = "I_MRAP_03_gmg_F";
		GUER_VEHICLE_LIGHT7 = "I_MRAP_03_gmg_F";
		//--- APCs
		GUER_VEHICLE_APC1 = "I_APC_Wheeled_03_cannon_F";
...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 3) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		GUER_SOLDIER_AR = "CUP_I_PMC_Soldier";
...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 5) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		GUER_VEHICLE_ARMORED2 = "CUP_I_M60A3_RACS";
...
//Urban
GUER_TOWNS_SQUAD_RIFLEMEN1_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_U, GUER_SOLDIER_U, GUER_SOLDIER_MEDIC_U];
...
GUER_TOWNS_SQUAD_AT1_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_LAT_U, GUER_SOLDIER_LAT_U, GUER_SOLDIER_LAT_U, GUER_SOLDIER_MEDIC];
...
GUER_TOWNS_SQUAD_LIGHT5_MIXED = GUER_TOWNS_SQUAD_LIGHT5 + GUER_TOWNS_SQUAD_AT2;
...
GUER_TOWNS_SQUAD_APC2_MIXED = GUER_TOWNS_SQUAD_APC2 + GUER_TOWNS_SQUAD_AT2;
...
GUER_TOWNS_SQUAD_ARMORED2_MIXED = GUER_TOWNS_SQUAD_ARMORED2 + GUER_TOWNS_SQUAD_AT2;
...
GUER_TOWNS_SQUAD_VEHICLE_AA2_MIXED = GUER_TOWNS_SQUAD_VEHICLE_AA2 + GUER_TOWNS_SQUAD_AT2;
