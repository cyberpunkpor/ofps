...
GUER_TOWNS_SQUAD_RIFLEMEN2 = [GUER_SOLDIER_TEAMLEADER, GUER_SOLDIER_AR, GUER_SOLDIER_AR, GUER_SOLDIER_MG, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MEDIC, GUER_SOLDIER_MG, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MEDIC, GUER_SOLDIER, GUER_SOLDIER, GUER_SOLDIER_GL, GUER_SOLDIER, GUER_SOLDIER, GUER_SOLDIER_AR];
GUER_TOWNS_SQUAD_RIFLEMEN3 = [GUER_SOLDIER_TEAMLEADER, GUER_SOLDIER_AR, GUER_SOLDIER_AR, GUER_SOLDIER_MG, GUER_SOLDIER_MG, GUER_SOLDIER_GL, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MEDIC, GUER_SOLDIER_MG, GUER_SOLDIER_GL, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MEDIC, GUER_SOLDIER_GL, GUER_SOLDIER, GUER_SOLDIER];
GUER_TOWNS_SQUAD_SNIPER = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER_SNIPER, GUER_SOLDIER_SNIPER, GUER_SOLDIER_SNIPER, GUER_SOLDIER_MEDIC, GUER_SOLDIER];
GUER_TOWNS_SQUAD_AT1 = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER_GL, GUER_SOLDIER_LAT, GUER_SOLDIER_LAT, GUER_SOLDIER_LAT, GUER_SOLDIER_AT, GUER_SOLDIER_MEDIC];
...
GUER_TOWNS_SQUAD_AA = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER_AA, GUER_SOLDIER, GUER_SOLDIER_AA, GUER_SOLDIER_MEDIC, GUER_SOLDIER_AA];
//Urban
...
GUER_TOWNS_SQUAD_RIFLEMEN2_U = [GUER_SOLDIER_TEAMLEADER_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MG_U, GUER_SOLDIER_EXP_U, GUER_SOLDIER_MEDIC_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MG_U, GUER_SOLDIER_EXP_U, GUER_SOLDIER_MEDIC_U, GUER_SOLDIER_U, GUER_SOLDIER_U];
GUER_TOWNS_SQUAD_RIFLEMEN3_U = [GUER_SOLDIER_TEAMLEADER_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MG_U, GUER_SOLDIER_GL_U, GUER_SOLDIER_MEDIC_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MG_U, GUER_SOLDIER_GL_U, GUER_SOLDIER_MEDIC_U];
...
GUER_TOWNS_SQUAD_AT1_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_GL_U, GUER_SOLDIER_LAT_U, GUER_SOLDIER_AT_U, GUER_SOLDIER_MEDIC, GUER_SOLDIER_LAT_U];
