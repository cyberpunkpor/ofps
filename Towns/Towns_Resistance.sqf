...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 0) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		GUER_VEHICLE_LIGHT6 = "CUP_I_ZSU23_Afghan_AAF";
		//--- Tanks
		GUER_VEHICLE_ARMORED1 = "CUP_I_M60A3_TTS_RACS";
		//GUER_VEHICLE_ARMORED2 = "CUP_B_M1A2C_TUSK_II_LDF";
		//--- AA Vehicles
...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 2) then { 
	...
	if (CTI_VANILLA_ADDON > 0) then {
		...
		GUER_SOLDIER_CREW = "I_C_Soldier_Para_7_F";
		...
		GUER_SOLDIER_SNIPER = "I_C_Soldier_Bandit_2_F";
		GUER_SOLDIER_MARKSMAN = "I_C_Soldier_Bandit_6_F";
		...
		GUER_VEHICLE_LIGHT2 = "I_C_Offroad_02_LMG_F";
		GUER_VEHICLE_LIGHT3 = "CUP_I_M151_M2_SYND";
		...
		GUER_AIR_HELI2 = "CUP_I_MTLB_pk_SYNDIKAT";
		GUER_AIR_AA = "I_Plane_Fighter_03_AA_F";
...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 4) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		GUER_VEHICLE_LIGHT3 = "CUP_I_Hilux_armored_BMP1_NAPA";
...
if (CTI_TOWNS_OCCUPATION_RESISTANCE isEqualTo 9) then { 
	...
	if (CTI_OFPS_UNITS_ADDON > 0) then {
		...
		GUER_VEHICLE_LIGHT6 = "OFPS_AWC_AT_SLAT_I";
		GUER_VEHICLE_APC3 = "OFPS_MORA_SLAT_LDF_I";
		GUER_TOWN_AT = "OFPS_F_KORNET_AT14_INDI";
...
GUER_TOWNS_SQUAD_ASSAULT_BOAT1 = [GUER_NAVAL_ASSAULT_BOAT1, GUER_NAVAL_ASSAULT_BOAT1, GUER_NAVAL_ASSAULT_BOAT1, GUER_NAVAL_ASSAULT_BOAT1, GUER_NAVAL_ASSAULT_BOAT2];
...
GUER_TOWNS_SQUAD_AIR1 = [GUER_AIR_HELI1, GUER_AIR_HELI1];
GUER_TOWNS_SQUAD_AIR1_SQUAD2 = [GUER_AIR_HELI1, GUER_AIR_HELI1, GUER_AIR_HELI1];
GUER_TOWNS_SQUAD_AIR1_SQUAD3 = [GUER_AIR_HELI1, GUER_AIR_HELI1, GUER_AIR_HELI1];
GUER_TOWNS_SQUAD_AIR2 = [GUER_AIR_HELI2, GUER_AIR_HELI2];
GUER_TOWNS_SQUAD_AIR2_SQUAD2 = [GUER_AIR_HELI2, GUER_AIR_HELI2, GUER_AIR_HELI2];
//--- Mixed Squads
