...
if (CTI_CUP_WEAPONS_ADDON > 0) then {
	...
	GUER_TOWN_D30 = "CUP_I_D30_TK_GUE";
	GUER_TOWN_D30AT = "CUP_I_D30_AT_TK_GUE";
	GUER_TOWN_DSHKM = "CUP_I_DSHKM_TK_GUE";
	GUER_TOWN_DSHKMLO = "CUP_I_DSHkM_MiniTriPod_TK_GUE";
	GUER_TOWN_KORD = "CUP_I_KORD_high_UN";
	GUER_TOWN_KORDLO = "CUP_I_KORD_UN";
	GUER_TOWN_M2 = "CUP_I_M2StaticMG_RACS";
	GUER_TOWN_M2LO = "CUP_I_M2StaticMG_MiniTripod_RACS";
	GUER_TOWN_M252 = "CUP_I_M252_RACS";
	GUER_TOWN_PODNOS = "CUP_I_2b14_82mm_TK_GUE";
...
//--- Statics Groups
GUER_TOWNS_STATICS_ALL = [GUER_TOWN_MG,GUER_TOWN_MGLO,GUER_TOWN_MK3MGLO,GUER_TOWN_MK3MG,GUER_TOWN_GLLO,GUER_TOWN_GL,GUER_TOWN_AA,GUER_TOWN_AT,GUER_TOWN_AGS,GUER_TOWN_D30,GUER_TOWN_D30AT,GUER_TOWN_DSHKM,GUER_TOWN_DSHKMLO,GUER_TOWN_KORD,GUER_TOWN_KORDLO,GUER_TOWN_M2,GUER_TOWN_M2LO,GUER_TOWN_M252,GUER_TOWN_PODNOS,GUER_TOWN_SPG,GUER_TOWN_ZSU];
...
GUER_TOWNS_STATICS_INFANTRY = [GUER_TOWN_MG,GUER_TOWN_MGLO,GUER_TOWN_MK3MGLO,GUER_TOWN_MK3MG,GUER_TOWN_GLLO,GUER_TOWN_GL,GUER_TOWN_MORTAR,GUER_TOWN_AGS,GUER_TOWN_DSHKM,GUER_TOWN_DSHKMLO,GUER_TOWN_KORD,GUER_TOWN_KORDLO,GUER_TOWN_M2,GUER_TOWN_M2LO,GUER_TOWN_M252,GUER_TOWN_PODNOS ];
GUER_TOWNS_STATICS_VEHICLE = [GUER_TOWN_AT,GUER_TOWN_D30,GUER_TOWN_D30AT,GUER_TOWN_SPG,GUER_TOWN_MORTAR];
GUER_TOWNS_STATICS_AIR = [GUER_TOWN_AA,GUER_TOWN_ZSU];

//--- Infantry Squads
GUER_TOWNS_SQUAD_RIFLEMEN1 = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER, GUER_SOLDIER, GUER_SOLDIER_AR, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MEDIC];
GUER_TOWNS_SQUAD_RIFLEMEN2 = [GUER_SOLDIER_TEAMLEADER, GUER_SOLDIER_AR, GUER_SOLDIER_AR, GUER_SOLDIER_MG, GUER_SOLDIER_MARKSMAN, GUER_SOLDIER_MEDIC];
GUER_TOWNS_SQUAD_RIFLEMEN3 = [GUER_SOLDIER_TEAMLEADER, GUER_SOLDIER_AR, GUER_SOLDIER_AR, GUER_SOLDIER_AR, GUER_SOLDIER_MG, GUER_SOLDIER_GL, GUER_SOLDIER_MARKSMAN,GUER_SOLDIER_MEDIC];
...
GUER_TOWNS_SQUAD_AT1 = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER_GL, GUER_SOLDIER_LAT, GUER_SOLDIER_LAT, GUER_SOLDIER_MEDIC];
GUER_TOWNS_SQUAD_AT2 = [GUER_SOLDIER_TEAMLEADER, GUER_SOLDIER_GL, GUER_SOLDIER_AT, GUER_SOLDIER_HAT, GUER_SOLDIER_MEDIC];
GUER_TOWNS_SQUAD_AA = [GUER_SOLDIER_SQUADLEADER, GUER_SOLDIER_AA, GUER_SOLDIER, GUER_SOLDIER_AA, GUER_SOLDIER_MEDIC];
//Urban
GUER_TOWNS_SQUAD_RIFLEMEN1_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_U, GUER_SOLDIER_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MARKSMAN_U, GUER_SOLDIER_U, GUER_SOLDIER_MEDIC_U];
GUER_TOWNS_SQUAD_RIFLEMEN2_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MG_U, GUER_SOLDIER_EXP_U, GUER_SOLDIER_MEDIC_U];
GUER_TOWNS_SQUAD_RIFLEMEN3_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MG_U, GUER_SOLDIER_GL_U, GUER_SOLDIER_MEDIC_U];
...
GUER_TOWNS_SQUAD_AT1_U = [GUER_SOLDIER_SQUADLEADER_U, GUER_SOLDIER_GL_U, GUER_SOLDIER_LAT_U, GUER_SOLDIER_AT_U, GUER_SOLDIER_MEDIC];
GUER_TOWNS_SQUAD_AT2_U = [GUER_SOLDIER_TEAMLEADER_U, GUER_SOLDIER_GL_U, GUER_SOLDIER_AT_U, GUER_SOLDIER_HAT_U, GUER_SOLDIER_MEDIC];
GUER_TOWNS_SQUAD_AA_U = [GUER_SOLDIER_TEAMLEADER_U, GUER_SOLDIER_AA_U, GUER_SOLDIER_AA_U, GUER_SOLDIER_AR_U, GUER_SOLDIER_MEDIC];
//Naval
