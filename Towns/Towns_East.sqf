...
EAST_TOWNS_STATICS_COMPS = EAST_TOWN_MG_COMP + EAST_TOWN_GL_COMP + EAST_TOWN_AT_COMP + EAST_TOWN_SPG_COMP + EAST_TOWN_DSHKM_COMP + EAST_TOWN_MG50_COMP + EAST_TOWN_MGLO_COMP + EAST_TOWN_M2LO_COMP + EAST_TOWN_AGS_COMP;
...
EAST_TOWNS_STATICS_ICOMPS =  EAST_TOWN_MG_COMP + EAST_TOWN_GL_COMP + EAST_TOWN_DSHKM_COMP + EAST_TOWN_MG50_COMP + EAST_TOWN_MGLO_COMP + EAST_TOWN_M2LO_COMP + EAST_TOWN_AGS_COMP;
EAST_TOWNS_STATICS_VCOMPS =  EAST_TOWN_AT_COMP + EAST_TOWN_SPG_COMP;

//--- Infantry Squads
EAST_TOWNS_SQUAD_RIFLEMEN1 = [EAST_SOLDIER_SQUADLEADER, EAST_SOLDIER_AR, EAST_SOLDIER, EAST_SOLDIER_MARKSMAN, EAST_SOLDIER, EAST_SOLDIER_MARKSMAN, EAST_SOLDIER_MEDIC];
EAST_TOWNS_SQUAD_RIFLEMEN2 = [EAST_SOLDIER_SQUADLEADER, EAST_SOLDIER_AR, EAST_SOLDIER_AR, EAST_SOLDIER_MG, EAST_SOLDIER_EXP, EAST_SOLDIER_MEDIC];
EAST_TOWNS_SQUAD_RIFLEMEN3 = [EAST_SOLDIER_SQUADLEADER, EAST_SOLDIER_AR, EAST_SOLDIER_AR, EAST_SOLDIER_AR, EAST_SOLDIER_MG, EAST_SOLDIER_GL, EAST_SOLDIER_MEDIC];
...
EAST_TOWNS_SQUAD_AA = [EAST_SOLDIER_SQUADLEADER, EAST_SOLDIER_AA, EAST_SOLDIER, EAST_SOLDIER_AA, EAST_SOLDIER_MEDIC];
//Urban
EAST_TOWNS_SQUAD_RIFLEMEN1_U = [EAST_SOLDIER_SQUADLEADER_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_U, EAST_SOLDIER_U, EAST_SOLDIER_MARKSMAN_U, EAST_SOLDIER_MARKSMAN_U, EAST_SOLDIER_U, EAST_SOLDIER_MEDIC_U];
EAST_TOWNS_SQUAD_RIFLEMEN2_U = [EAST_SOLDIER_SQUADLEADER_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_MG_U, EAST_SOLDIER_EXP_U, EAST_SOLDIER_MEDIC_U];
EAST_TOWNS_SQUAD_RIFLEMEN3_U = [EAST_SOLDIER_SQUADLEADER_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_MG_U, EAST_SOLDIER_GL_U, EAST_SOLDIER_MEDIC_U];
